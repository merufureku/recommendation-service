package com.merufureku.aromatica.recommendation_service.constants;

public class RecommendationCollectionConstants {
    ...
    public static final float GREAT = 1.5F;
    public static final float EXCELLENT = 2.0F;

    public static final int MINIMUM_RATING = 4;
